                        ...
                        <tr>
                           <td>
                              <div class="text" style="padding: 0 2.5em; text-align: left;">
                                 <h2 style="text-align: center; background-color: #cccccc;">{{ ucfirst($subject) }}</h2>
                                 <p>
                                    Dear {{ $details['full_name'] }},<br>
                                    <br>
                                    Your One Time Password (OTP) for balance withdrawal transactions is {{ $details["otp"] }}. This OTP is valid for next 90 seconds.<br>
                                    <br>
                                    For your transaction security, please DO NOT share this One Time Password (OTP) with ANYONE.<br>
                                 </p>
                                 
                                 <p>Sincerely,<br>
                                 <strong>Capital Grow LLC.</strong><br></p>
                              </div>
                           </td>
                        </tr>
                     </table>
